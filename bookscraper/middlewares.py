...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def process_request(self, request, spider):
        random_user_agents = self._get_random_user_agents()
        request.headers['User_Agent'] = random_user_agents
        print("*********** NEW HEADER ATTACHED ******")
        print(request.headers['User_Agent'])



class ScrapeOpsFakeBrowserHeaderUserAgentMiddleware:
    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_headers_active = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADER_ACTIVE_ENABLED', True)
    ...
    def _scrapeops_fake_browser_headers_enabled(self):
        if self.scrapeops_api_key is None or self.scrapeops_api_key == '' or self.scrapeops_fake_browser_headers_active:
